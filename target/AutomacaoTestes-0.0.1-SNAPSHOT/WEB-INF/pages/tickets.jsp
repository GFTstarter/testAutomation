					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<form:select path="status" id="ticketStatus"
								...
								<form:option value="Ready for Development"
						...
						<input type="hidden" name="id_release" id="id_release"
							value="${id_release}" /> <input type="hidden" name="project"
							id="project" value="${project}" /> <input type="hidden"
							name="tag" id="tag" value="${tag}" /> <input type="hidden"
							name="id_ticket" id="id_ticket" value="${id_ticket}" />
					</div>
